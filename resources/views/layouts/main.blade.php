        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/registrar">Cadastre-se</a></li>
                    <li class="nav-item"><a class="nav-link" href="/measurements">List</a></li>
                    <li class="nav-item"><a class="nav-link" href="/measurements/new">Form</a></li>
                </ul>
            </div>
        </div>
    </nav>
